...
{
    [SerializeField] private GunShootingFunction _gunShootingFunction;
    ...
    private void ThrowGrenade()
    {
        ...
        if (rb != null)
        {
            rb.AddForce(_mainCamera.transform.forward * _currentThrowForce, ForceMode.Impulse);
        }
